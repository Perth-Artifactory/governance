...
At the \href{https://wiki.artifactory.org.au/en/minutes/AGM/2026-09-12}{AGM held 2026-09-12} ---

\begin{itemize}
    \item Added a new clause s\ref{no-confidence-in-committee-nominee}, adding a "no confidence" mechanism for committee nominees.
    \item In s\ref{terms-used}, defined the term "written notice" to include notices sent via electronic platforms.
    \item In s\ref{terms-used}, amended the definition of "direct message" to include direct messages sent via any of the Association's electronic platforms.
\end{itemize}
